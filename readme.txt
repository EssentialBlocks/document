...
🧡 LOVED Document Block? Rate us on [WordPress Repository](https://wordpress.org/support/plugin/document/reviews/#new-post)
...
= Old Way: =
1. Upload `document` to the `/wp-content/plugins/` directory
